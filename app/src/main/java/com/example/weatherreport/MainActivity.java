...
public class MainActivity extends AppCompatActivity {
    ...
    //天气预报API常量
    public static final String WEATHER_REALTIME_URL = "https://api.seniverse.com/v3/weather/now.json?key=SZVehU84iD1Azp7dO&language=zh-Hans&unit=c&location=";
    public static final String WEATHER_TODAY_URL = "https://api.seniverse.com/v3/weather/daily.json?key=SZVehU84iD1Azp7dO&language=zh-Hans&unit=c&start=0&days=1&location=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                try{
                    ...
                    getRequest(WEATHER_REALTIME_URL+city, WEATHER_REALTIME);
                    getRequest(WEATHER_TODAY_URL+city, WEATHER_TODAY);
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
        ...
        gpsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, CitySelection.class);
                startActivity(i);
            }
        });
    ...
    private void initShareBtn(){
        ...
        btnShare = findViewById(R.id.ib_share);
